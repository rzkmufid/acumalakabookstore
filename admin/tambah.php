...
if (!isset($_SESSION["login"]) == true){
    ...
    if (isset($_POST["Simpan"])) {
        ...
        $q="INSERT INTO buku VALUES('','$judul','$kategori','$penerbit','$pengarang','$halaman','$tanggalTerbit','$berat','$panjang','$lebar','$deskripsi','$harga','$filename','$stok')";
        mysqli_query($conn,$q);
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Tambah Catalog Buku</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home Admin</a></li>
              <li class="breadcrumb-item active">Tambah Catalog Buku</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="container-fluid">
        ...
        <table class="table">
            ...
            <tr>
                <td>Halaman</td>
                <td>:</td>
                <td><input class="form-control" type="text" name="halaman"></td>
            </tr>
            <tr>
                <td>Tanggal terbit</td>
                <td>:</td>
                <td><input class="form-control" type="date" name="tanggalTerbit"></td>
            </tr>
            <tr>
                <td>Berat</td>
                <td>:</td>
            ...
            <tr>
                <td>Panjang</td>
                <td>:</td>
                <td><input class="form-control" type="text" name="panjang"></td>
            </tr>
            <tr>
                <td>Lebar</td>
                <td>:</td>
                <td><input class="form-control" type="text" name="lebar"></td>
            </tr>
            <tr>
                <td>Deskripsi</td>
                <td>:</td>
                <td><textarea class="form-control" name="deskripsi" id="" cols="50" rows="12"></textarea></td>
            </tr>
            <tr>
                <td>Harga</td>
                <td>:</td>
            ...
            <tr>
                <td>Gambar Buku</td>
                <td>:</td>
                <td><input class="form-control" type="file" name="gambarBuku"></td>
            </tr>
            <tr>
                <td>Stok Buku</td>
                <td>:</td>
            ...
            <tr>
                <td></td>
                <td></td>
                <td><button style="float: right;" class="btn btn-primary" type="submit" name="Simpan">Simpan</button></td>
            </tr>
        </table>
    </form>
    </div>
