...
$conn = mysqli_connect('localhost','root','','acumalaka');
    if (isset($_POST["Simpan"]))
    {
        ...
        $q="INSERT INTO pelanggan VALUES('','$username','$password','$level','$namaDepan','$namaBelakang')";
        mysqli_query($conn,$q);
...
<form action="" method="post" class="container-fluid">
    <table>
        <tr>
            <td>Nama Depan</td>
            <td>:</td>
            <td><input class="form-control" type="text" name="namaDepan"></td>
        </tr>
        <tr>
            <td>Nama Belakang</td>
            <td>:</td>
            <td><input class="form-control" type="text" name="namaBelakang"></td>
        </tr>
        <tr>
            <td>Level</td>
            <td>:</td>
        ...
        <tr>
            <!-- <td><a href="buku.php" class="btn btn-secondary mt-4">Kembali</a></td> -->
            <!-- <td></td> -->
            <td colspan="3"><button type="submit" class="btn btn-primary mt-4" name="Simpan">Simpan</button></td>
        </tr>
    </table>
</form> <!-- /.content -->
