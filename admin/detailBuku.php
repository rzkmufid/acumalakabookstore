...
if (isset($_POST["Edit"]))
    {
        ...
        $q="UPDATE buku SET judul ='$judul', kategori = '$kategori', penerbit = '$penerbit', pengarang = '$pengarang', halaman = '$halaman', tanggalTerbit = '$tanggalTerbit', berat = '$berat', panjang = '$panjang', lebar = '$lebar', deskripsi = '$deskripsi' WHERE id='$id'";
        mysqli_query($conn,$q);
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><a href="buku.php" class="btn btn-primary">⬅️Back</a></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<table class="table">
        <tr>
            <td>Cover buku</td>
            <td>:</td>
            <td><img width="100" src="../assets/img/<?php echo $row["gambarBuku"]; ?>" alt=""></td>
        </tr>
        <tr>
            <td>Judul buku</td>
            <td>:</td>
